...
function FaceLiveness({ faceLivenessAnalysis }) {
    ...
    useEffect(() => {
        ...
        const fetchCreateLiveness = async () => {
            ...
            const response = await fetch('https://15mr7a2wka.execute-api.us-east-1.amazonaws.com/dev/create');
   ...
   */
    const handleAnalysisComplete = async () => {
        ...
        const response = await fetch('https://15mr7a2wka.execute-api.us-east-1.amazonaws.com/dev/' + sessionId,
            {
                method: 'POST',
                headers: {
